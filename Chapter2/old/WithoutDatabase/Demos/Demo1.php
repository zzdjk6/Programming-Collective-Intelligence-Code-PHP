...
$similarity = SimilarityCaculator::getSimilarityByEuclideanDistance($personLisa, $personGene);
echo "The similarity between {$personLisa->getName()} and {$personGene->getName()} is {$similarity}";
//The similarity between Lisa Rose and Gene Seymour is 0.29429805508555